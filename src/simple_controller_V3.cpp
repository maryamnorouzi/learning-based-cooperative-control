...
enum { WX=0, WY=1, WZ=2, WROLL=3, WPITCH=4, WYAW=5 };
...
private:
  ...
  void setup_math_() {
    ...
    const std::array<double,4> qd0 = { A*wx, A*2*wy, 0.0, 0.0};      
  ...
  void process_data()
  {
    ...
    x_f[1] = static_cast<float>(X_world[Y] / 10.0);         // scale_ang_
